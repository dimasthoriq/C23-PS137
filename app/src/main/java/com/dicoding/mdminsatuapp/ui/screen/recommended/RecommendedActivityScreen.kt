package com.dicoding.mdminsatuapp.ui.screen.recommended
...
@Composable
fun RecommendedActivityScreen(navController: NavController) {
    Scaffold(
        topBar = {
            TopBar(
...
@Composable
fun RecommendedActivityScreenPreview() {
    RecommendedActivityScreen(navController = NavController(LocalContext.current))
}